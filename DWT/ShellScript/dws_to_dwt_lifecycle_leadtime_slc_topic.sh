...
insert overwrite table dwt_lifecycle_leadtime_SLC_topic partition(dt_year, dt_month)
select  month(pgi_date)                               as pgi_month
       ...
       ,percentile_approx(slc_product_putaway,0.5)    as slc_product_putaway
...
echo "End syncing lifecycle_leadtime_slc data into DWT layer on $sync_date .................."