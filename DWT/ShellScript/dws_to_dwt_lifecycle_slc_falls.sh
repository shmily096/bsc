...
insert overwrite table dwt_lifecycle_slc_falls partition(dt_year, dt_month)
SELECT 
      pgi_month, pgi_year, 
      ...
      dt_year,
      dt_month
FROM dwt_lifecycle_leadtime_slc_topic
...
SELECT 
      ...
      product_line1, product_line2, product_line3, product_line4, product_line5, 
      cust_level1, cust_level2, cust_level3, cust_level4,
      'slc_product_putaway' AS leadtime_section,
      slc_product_putaway as leadtime,
      dt_year,
      dt_month
FROM dwt_lifecycle_leadtime_slc_topic
      where dt_month='${sync_date[month]}'
      and dt_year= '${sync_date[year]}'
   GROUP BY pgi_month, pgi_year, product_line1, product_line2, product_line3, product_line4, product_line5, 
   cust_level1, cust_level2, cust_level3, cust_level4, slc_product_putaway,
   dt_year, dt_month
UNION all
SELECT 
      pgi_month, pgi_year, 
