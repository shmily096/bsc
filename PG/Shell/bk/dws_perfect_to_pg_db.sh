...
dwd_perfect_detail_data() {
    echo "Start export data dwd_perfect_detail"
    #export path table by table
    NEW_export_dir="/bsc/opsdw/export/dwd_perfect_detail"  # HDFS 文件路径
    tablename='dwd_perfect_detail_merge' #PG 处理数据的存储过程    
    #清空最近31天的数据
    demo_export_dir="/bsc/opsdw/export/ads_demo"  # HDFS 文件路径
    demo_pg_funcion="dwd_perfect_detail_del" #PG 删除数据的存储过程
    export_data $demo_pg_funcion $demo_export_dir
    #插入数据全量更新 暂时是推23年及以后的数据
