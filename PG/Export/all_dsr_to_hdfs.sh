...
;
"
dws_finance_net_sales_gap="
use ${target_db_name};
insert OVERWRITE directory '/bsc/opsdw/export/dws_finance_net_sales_gap'
row format delimited fields terminated by '\001' 
stored as textfile
SELECT 
	*
    FROM opsdw.dws_finance_net_sales_gap
;
"
...
;
"
dws_finance_cogs_inventory_revaluation_detail="
use ${target_db_name};
insert OVERWRITE directory '/bsc/opsdw/export/dws_finance_cogs_inventory_revaluation_detail'
row format delimited fields terminated by '\001' 
stored as textfile
SELECT 
	*
    FROM opsdw.dws_finance_cogs_inventory_revaluation_detail
;
"
dws_eeo_detail="
use ${target_db_name};
...
elif [ "$1"x = "dws_finance_cogs_inventory_revaluation_detail"x ];then
    echo " hdfs $1 only run"
	echo "$dws_finance_cogs_inventory_revaluation_detail"
	$hive -e "$dws_finance_cogs_inventory_revaluation_detail"
	echo "hdfs  finish dws_finance_cogs_inventory_revaluation_detail data into hdfs layer on ${sync_date} .................."
...
elif [ "$1"x = "dws_finance_net_sales_gap"x ];then
    echo " hdfs $1 only run"
	echo "$dws_finance_net_sales_gap"
	$hive -e "$dws_finance_net_sales_gap"
	echo "hdfs  finish dws_finance_net_sales_gap data into hdfs layer on ${sync_date} .................."
