...
create temporary function myudf as 'com.an.Nmu';
...
SELECT
                ...
                get_certificatelist, -- 是否拿到出证清单                                      
                status --状态
, CAST((unix_timestamp(customclearance_date) - unix_timestamp(distributedoc_receivedate))/(60 * 60) AS float)  as distirib_custom_cd  
