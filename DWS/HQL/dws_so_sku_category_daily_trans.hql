...
drop table if exists dws_so_sku_category_daily_trans;
create external table dws_so_sku_category_daily_trans
(
...
) comment 'SO category Daily Transation'
partitioned by(dt string) 
stored as parquet
location '/bsc/opsdw/dws/dws_so_sku_category_daily_trans/'
